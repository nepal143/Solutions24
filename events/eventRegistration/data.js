const events = [
  ...
  [
    ...
    // MOVIE MAKING
    {
      ...
      paragraph:
        "<b>GUIDELINES :</b><br>1. The Short Film should be original and any content from youtube or any other already available sources will lead to disqualification.<br>2. It should not have any kind of vulgar content or any content which can hurt the feelings of any community/person.<br>3. All the particpants involved in the process should be included in the credits along with their respective year and college.<br>4. Time limit is 10+6 minutes. Negative marking will be done if the time limit is exceeded or lagged (5 points deduction for every 5 seconds).<br>5. The participants have to submit their movie before 22nd April 11:50 PM to <a class='mail_link' href='mailto:ait.solutions2k23@gmail.com'>ait.solutions2k23@gmail.com</a><br>6. A copy of abstract describing the theme and story of the movie should be submitted. Failing to do so will lead to direct disqualification.<br>7. Changes in the pattern can be made with prior notice (minimum 2 days before the event) to the participants.<br>8. Themes are :<br>Gender Equity<br>Horror.<br>Lifestyle at Hostel<br>Science Fiction and Time Travel.<br>9. Recreation with some modification is allowed.",
      descriptionDown: "",
    },
    // SCHOOL MODEL MAKING
    {
